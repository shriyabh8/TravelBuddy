  ...
  return (
    ...
    font-poppins text-gray-800"
      ...
      <div className="text-center p-12 bg-white rounded-xl shadow-2xl max-w-2xl mx-auto min-h-[40vh] flex flex-col justify-center items-center z-10">
        <h1 className="text-6xl font-poppins font-extrabold mb-8 text-[#36a2a4] leading-tight tracking-tight">
          Welcome to Your Travel Buddy!
        </h1>
        <p className="text-2xl font-open-sans leading-relaxed mb-12 mt-8 text-[#383a32] max-w-md">
